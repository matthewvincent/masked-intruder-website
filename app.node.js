...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "@font-face {\n\tfont-family: 'Cooper Std';\n\tsrc: url('/../static/CooperBlack/CooperBlackStd.eot');\n\tsrc: url('/../static/CooperBlack/CooperBlackStd.eot?#iefix') format('embedded-opentype'),\n\t\turl('/../static/CooperBlack/CooperBlackStd.woff') format('woff'),\n\t\turl('/../static/CooperBlack/CooperBlackStd.ttf') format('truetype'),\n\t\turl('/../static/CooperBlack/CooperBlackStd.svg#CooperBlackStd') format('svg');\n\tfont-weight: 900;\n\tfont-style: normal;\n}\n\n\n/*\n * Scaffolding\n * -------------------------------------------------------------------------- */\n\n/*\n * Typography\n * -------------------------------------------------------------------------- */\n\n\n\n/*\n * Animations\n * -------------------------------------------------------------------------- */\n\n\n/*\n * Video\n * -------------------------------------------------------------------------- */\n\n.responsive-video-wrapper {\n\tposition: relative;\n\tpadding-bottom: 56.25%; /* 16:9 */\n\tpadding-top: 25px;\n\theight: 0;\n}\n\n.responsive-video-wrapper iframe {\n\tposition: absolute;\n\tborder: 0 none;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\t-webkit-box-shadow: 4px 4px 8px -2px rgba(0,0,0,0.25);\n\t        box-shadow: 4px 4px 8px -2px rgba(0,0,0,0.25);\n}\n\n.desktop-navigation {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n  -webkit-flex-direction: row;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  margin: 3em 0 5em 0;\n  list-style: none;\n  -webkit-box-pack: end;\n  -webkit-justify-content: flex-end;\n      -ms-flex-pack: end;\n          justify-content: flex-end;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n}\n\n.desktop-navigation li {\n\t-webkit-transform: scale(.8);\n\t    -ms-transform: scale(.8);\n\t     -o-transform: scale(.8);\n\t        transform: scale(.8);\n\tmargin-right: -20px;\n\tmargin-left: -20px;\n}\n\n.brand {\n  position: absolute;\n  left: 40px;\n  top: 10px;\n  width: 200px;\n}\n\n.desktop-nav-hidden {\n  visibility: hidden;\n  display: none;\n}\n\n.desktop-nav-show {\n  visibility: visible;\n}\n\n.mobile-navigation {\n  position: absolute;\n  height: 100%;\n}\n\n.mobile-navbar {\n  position: relative;\n  height: 60px;\n  width: 100%;\n  z-index: 1500;\n  background-color: rgba(255,255,255,.5);\n}\n\n.mobile-nav-hidden {\n  visibility: hidden;\n}\n\n.mobile-nav-show {\n  visibility: visible;\n}\n\n.mobile-nav-links {\n  height: 350px;\n  top: 50%;\n  margin-top: -160px;\n  position: relative;\n  padding: 0px;\n\n}\n\n.mobile-nav-links li {\n\ttext-align: center;\n\tfont-size: 40px;\n\tlist-style: none;\n\tmargin-top: 30px;\n}\n\n.mobile-menu-background {\n  position: absolute;\n  z-index: 3000;\n  height: 100%;\n  width: 100%;\n  top: 0;\n  background-color: rgba(255,255,255,1);\n  text-align: center;\n}\n\n.mobile-menu-wrapper-open {\n  opacity: 1;\n  visibility: visible;\n}\n\n.mobile-menu-wrapper-closed {\n  opacity: 0;\n  visibility: hidden;\n}\n\n.mmbOpen a {\n  opacity: 1;\n  -webkit-transition: opacity 1.3s ease-in .2s;\n  -o-transition: opacity 1.3s ease-in .2s;\n  transition: opacity 1.3s ease-in .2s;\n}\n\n.mmbClosed a {\n  opacity: 0;\n}\n\n.menu-icon {\n  position: absolute;\n  z-index: 4000;\n  width: 120px;\n  margin-top: 22px;\n  left: 100%;\n}\n\n.menu-title {\n  font-size: 15px;\n  margin-left: 4px;\n  display: inline;\n}\n\n.burger {\n  font-size: 20px;\n  display: inline-block;\n}\n\n.close {\n  font-size: 20px;\n  display: inline-block;\n}\n\n.Navigation-item {\n  padding: 0 1em;\n  opacity: 1;\n  -webkit-transition: -webkit-transform .2s ease-out;\n  transition: -webkit-transform .2s ease-out;\n  -o-transition: transform .2s ease-out, -o-transform .2s ease-out;\n  transition: transform .2s ease-out;\n  transition: transform .2s ease-out, -webkit-transform .2s ease-out, -o-transform .2s ease-out\n}\n\n.Navigation-item:hover{\n\t-webkit-transform: scale(.95);\n\t    -ms-transform: scale(.95);\n\t     -o-transform: scale(.95);\n\t        transform: scale(.95);\n}\n\n.nav-item-hidden {\n  opacity: 0;\n}\n\n.animate-nav-item {\n  -webkit-animation: slide .4s 1;\n       -o-animation: slide .4s 1;\n          animation: slide .4s 1;\n}\n\n.Navigation-link {\n  font-size: 40px;\n  padding-top: 10px;\n  padding-right: 20px;\n  padding-left: 20px;\n  color: rgba(0,0,0,.8);;\n  background-color: #99c3db;\n  text-decoration: none;\n  text-transform: uppercase;\n  cursor: pointer;\n  border: 3px solid rgba(0,0,0,.8);\n  border-radius: 30px;\n  -webkit-transition: all .3s ease-out;\n  -o-transition: all .3s ease-out;\n  transition: all .3s ease-out;\n  -webkit-box-shadow: 4px 4px 8px -2px rgba(0,0,0,0.25);\n          box-shadow: 4px 4px 8px -2px rgba(0,0,0,0.25);\n\n  \n}\n\n@-webkit-keyframes slide {\n  0% { -webkit-transform: translateX(-10em); transform: translateX(-10em); opacity: 0 }\n  100%{-webkit-transform: translateX(0em);transform: translateX(0em); opacity: 1 }\n}\n\n@-o-keyframes slide {\n  0% { -o-transform: translateX(-10em); transform: translateX(-10em); opacity: 0 }\n  100%{-o-transform: translateX(0em);transform: translateX(0em); opacity: 1 }\n}\n\n@keyframes slide {\n  0% { -webkit-transform: translateX(-10em); -o-transform: translateX(-10em); transform: translateX(-10em); opacity: 0 }\n  100%{-webkit-transform: translateX(0em);-o-transform: translateX(0em);transform: translateX(0em); opacity: 1 }\n}\n\n/* ipad */\n@media only screen \n  and (min-device-width: 768px) \n  and (max-device-width: 1024px) \n  and (orientation: portrait) \n  and (min-device-pixel-ratio: 1) {\n\n    .mobile-nav-links {\n      height: 600px;\n      top: 50%;\n      margin-top: -300px;\n      position: relative;\n      padding: 0px;\n    }\n\n    .mobile-nav-links li {\n      text-align: center;\n      font-size: 80px;\n      list-style: none;\n      margin-top: 30px;\n      font-weight: lighter;\n    }\n}\n\n@media only screen and (min-width: 769px) {\n  .mobile-navigation {\n    visibility: hidden;\n  }\n\n  .mobile-navbar {\n    visibility: hidden;\n  }\n}", ""]);
